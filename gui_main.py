...
class TestApp(App):
    ...
    def build(self):
        ...
        self.tile_1 = Button(size_hint=(1 / 3, 1 / 3), pos_hint={'x': 0, 'top': 1}, text='1', background_color=[1, 0, 0, 1])
        self.tile_2 = Button(size_hint=(1 / 3, 1 / 3), pos_hint={'x': 1 / 3, 'top': 1}, text='2', background_color=[1, 0, 0, 1])
        self.tile_3 = Button(size_hint=(1 / 3, 1 / 3), pos_hint={'x': 2 / 3, 'top': 1}, text='3', background_color=[1, 0, 0, 1])
        self.tile_4 = Button(size_hint=(1 / 3, 1 / 3), pos_hint={'x': 0, 'top': 2 / 3}, text='4', background_color=[1, 0, 0, 1])
        self.tile_5 = Button(size_hint=(1 / 3, 1 / 3), pos_hint={'x': 1 / 3, 'top': 2 / 3}, text='5', background_color=[1, 0, 0, 1])
        self.tile_6 = Button(size_hint=(1 / 3, 1 / 3), pos_hint={'x': 2 / 3, 'top': 2 / 3}, text='6', background_color=[1, 0, 0, 1])
        self.tile_7 = Button(size_hint=(1 / 3, 1 / 3), pos_hint={'x': 0, 'top': 1 / 3}, text='7', background_color=[1, 0, 0, 1])
        self.tile_8 = Button(size_hint=(1 / 3, 1 / 3), pos_hint={'x': 1 / 3, 'top': 1 / 3}, text='8', background_color=[1, 0, 0, 1])
        self.tile_0 = Button(size_hint=(1 / 3, 1 / 3), pos_hint={'x': 2 / 3, 'top': 1 / 3}, text='', background_color=[0, 0, 0, 0])
